...
BASE=Path(os.environ.get('RQ8C_BASE','/path/to/results/rq8/conditional_shift50_v1'))
SEED=int(os.environ.get('RQ8C_SEED','42'))
PATHOLOGY=os.environ.get('RQ8C_PATHOLOGY','Edema')
